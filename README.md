...
5. 토글버튼을 이용해 완료 리스트 모아보기 닫기 기능
6. 태그 추가 / 수정 / 삭제 기능
7. 로컬 스토리지를 활용하여 Todo와 태그 데이터 영속성 유지
8. 태그를 이용한 필터 기능
9. 입력창에 값을 입력받아 Todo 제목 기준으로 검색 기능
10. 반응형 작업 (최소 해상도 375px)
...
7. TODO에 있는 체크박스로 완료 미완료 토글할 수 있습니다. (자동으로 완료 목록에 추가되어 상단에 위치한 완료 모아보기에 추가됩니다.)
